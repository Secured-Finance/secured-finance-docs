...
- A web3 wallet (like MetaMask) installed and configured for Filecoin Calibration testnet
...
4. Request tFIL (you can receive up to 100 tFIL)
5. Wait for the transaction to complete (this usually takes a few minutes)

[IMAGE PLACEHOLDER: Screenshot of the Filecoin Calibration testnet faucet interface with wallet connection and request process highlighted]
...
[IMAGE PLACEHOLDER: Screenshot of the USDFC testnet application homepage with the Connect Wallet button highlighted]
...
1. On the USDFC testnet application, navigate to the "Mint" or "Trove" section
...
5. Click "Mint USDFC" or "Create Trove" to proceed
6. Confirm the transaction in your wallet
7. Wait for the transaction to be confirmed on the blockchain

[IMAGE PLACEHOLDER: GIF or series of screenshots showing the process of minting USDFC with tFIL collateral]

## Step 4: Add Test USDFC to Your Wallet

After minting, you'll want to see your test USDFC in your wallet.

1. In your wallet (e.g., MetaMask), click "Add Token" or "Import Token"
2. Select "Custom Token"
3. Enter the test USDFC token contract address (available on the USDFC testnet application)
4. The token symbol (USDFC) and decimals should auto-populate
5. Click "Add" or "Import" to add test USDFC to your wallet

[IMAGE PLACEHOLDER: GIF showing the process of adding USDFC to a wallet like MetaMask]
...
[IMAGE PLACEHOLDER: Screenshot of the Stability Pool interface on testnet]

### Fixed Rate Lending Market

While Bridge and SushiSwap features are not available on testnet, you can use the USDFC fixed rate lending market on [https://stg.secured.finance](https://stg.secured.finance).

1. Visit [https://stg.secured.finance](https://stg.secured.finance)
2. Connect your wallet
3. Navigate to the lending markets
4. Explore lending or borrowing with your test USDFC

[IMAGE PLACEHOLDER: Screenshot of the Secured Finance testnet lending interface]
...
- The USDFC fixed rate lending market is available at [https://stg.secured.finance](https://stg.secured.finance)
