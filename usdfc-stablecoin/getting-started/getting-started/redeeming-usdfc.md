...
{% hint style="warning" %}
Repayment is adjusting your own trove. Redemption instead targets whichever troves have the lowest collateral ratios in the system (among those at or above 110% — troves below that are left for liquidation) — you cannot choose which trove is affected.\
