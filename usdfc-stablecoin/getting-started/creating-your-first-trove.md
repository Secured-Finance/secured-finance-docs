...
1. On the USDFC dashboard, locate and click on the "Trove" or "Mint USDFC" option
2. You'll be directed to the Trove creation page
...
1. Click the "Create Trove" or "Open Trove" button
...
3. If you don't see USDFC in your wallet, you may need to add it as a custom token
