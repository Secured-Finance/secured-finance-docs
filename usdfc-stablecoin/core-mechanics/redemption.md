...
The **Redemption Fee** is calculated as[ **Base Rate**](mint-to-borrow.md#base-rate-explanation) **+ 0.5%**, which ensures a minimum fee of **0.5%**. This fee dynamically adjusts depending on redemption activity:
