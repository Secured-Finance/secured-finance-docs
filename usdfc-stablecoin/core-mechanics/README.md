...
This section explains the mechanisms behind USDFC — how minting, liquidation, and redemption are designed to keep the system over-collateralized with FIL and the peg anchored to $1. If you want to *do* things rather than understand them, start with [Getting Started](../getting-started/README.md).
