...
* **Maturity drift** — as bonds approach maturity their price rises toward par, which generally _helps_ collateral value, but rolls restate positions at market rates.

## Related

* [Collateral](collateral.md) — the general collateral framework
* [Liquidation](liquidation/) — thresholds and process
