...
You specify the price (rate). The order executes at your price or better, and rests on the book until filled, canceled, or expired (you can set an optional expiry; unfilled orders also expire at the market's maturity).

* You act as a **maker**, adding liquidity — limit orders pay **no trading fee**
* If your price overlaps existing orders, the overlapping part executes immediately
