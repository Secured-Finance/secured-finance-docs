...
The **Fixed-Rate Lending Protocol** solves this with an instrument that traditional finance has used for centuries: the **Zero-Coupon (ZC) bond**. You buy a bond at a discount today and it is worth its full face value at maturity — the discount _is_ your interest, fixed at the moment of the trade.
