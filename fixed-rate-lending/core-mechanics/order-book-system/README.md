...
Secured Finance's Loan Market Platform incorporates an on-chain orderbook system, a pioneering application in the DeFi space. This system facilitates the trading of [Zero-Coupon bonds](../standardization/zero-coupon-bonds.md) with a specific maturity date. To ensure clarity, we've defined some key terms used on our platform:
...
## What is a [**Zero-Coupon Bond (ZC bond)**](../standardization/zero-coupon-bonds.md)?
