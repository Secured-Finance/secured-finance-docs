---
description: >-
  Understanding the liquidation process that maintains solvency in the
...
* [**Liquidators**](liquidators/): The third-party actors who execute liquidations
* [**Case Study**](liquidation-case-study.md): A detailed example of the liquidation process
...
* Liquidations are typically executed by third-party [Liquidators](liquidators/) who are incentivized to perform this action.
...
> See a detailed example in the [Liquidation Case Study](liquidation-case-study.md).\
> Learn more about the role of liquidators in [Liquidators](liquidators/).

## Related Resources

* [Collateralization](../collateralization.md)
* [Order Book System](../order-book-system/)
* [Safety Measures](../../advanced-topics/safety-measures/)
