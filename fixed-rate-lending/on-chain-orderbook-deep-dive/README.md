---
description: How to Build an On-Chain Orderbook
---
...
* Executing [market orders](../platform-guide/trading/order-type.md) results in escalating gas costs proportional to the number of matched open orders, potentially leading to execution challenges in certain cases.
* [Auto-rolling](../advanced-topics/auto-rolling/) faces mounting gas costs proportional to the number of positions subject to auto-rolling, potentially leading to execution challenges in certain scenarios.
