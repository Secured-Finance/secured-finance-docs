...
5. **Mathematical Implementation**: For upward movement, we use Min(Max(MA3 + 10%, MA3 + 7.00), Price), and for downward movement, we use Max(Min(MA5 - 5%, MA5 - 2.00), Price)
