---
description: >-
  Why a full on-chain order book is hard — and the three techniques that make
  ours economical
---
...
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [**Red-Black Tree**](red-black-tree.md)                                     | O(log n) insertion, deletion, and best-price lookup for orders, with a custom _unlink_ operation for bulk removal of matched orders        |
...
| [**Genesis Value & Compound Factor**](genesis-value-and-compound-factor.md) | Rolls _every_ position at maturity by updating a single factor, instead of touching each position individually                             |
