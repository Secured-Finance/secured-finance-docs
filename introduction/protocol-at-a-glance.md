---
description: >-
  Traction, security, and technology — the three-minute read for investors,
...
| **SF Yield Vault**     | Curated yield strategies — currently JPYC and USDFC lending                        | Ethereum, Filecoin           |
...
See the [Roadmap](roadmap/) for the full delivery history.
...
| A researcher or investor  | [Research & Papers](../fixed-rate-lending/research-and-papers.md) · [Roadmap](roadmap/)    |
